...
Player :: Player(string sprite_path, int num_rotations, int startingAngle) 
	: Object(sprite_path, 200,200,1000,num_rotations,startingAngle)
...
Player :: Player(string sprite_path, int num_rotations, int startingAngle,
		...
		: Object(sprite_path,startX,startY,1000,num_rotations,startingAngle)
//		, sprite(sprite_path,num_rotations,startingAngle)
//{{{
{
	descriptor.xAcc = 0;
...
Player :: Player(string sprite_path, int num_rotations, int startingAngle,
		...
		: Object(sprite_path,startX,startY,1000, num_rotations,startingAngle,0,0,HC_path)
	//, sprite(sprite_path, num_rotations,startingAngle)
//{{{
{
	descriptor.xAcc = 0;
